...
[Ilythia Morley](https://blogs.ubc.ca/imorley/) is a recent tst  MSc graduate in environmental science. Her research focused on the application of planetary-scale satellite data for predictive ecology and wildlife connectivity modelling. Ilythia will act as the project coordinator for this project to facilitate communication, data transfers, and product testing.
...
Lauren Quist is an analyst and planner at [Hearst Forest Management Inc](http://www.hearstforest.com/english/indexen.html), and formally worked as a contractor for the MNFR. Lauren assists in preparing 10-year forest management plans, is a certified Photo-Interpreter for the Boreal Forest and Great Lakes - St.L. Forest, and works with FRI and LiDAR data to produce timber volume estimates. In her current role, Lauren’s responsibilities include producing FSC documentation & products (e.g. update Gap Analysis, HCV, caribou strategy), caribou habitat & disturbance analysis, and the preparation of annual forest management reports. Lauren is fascinated by the thinking and assumptions - right and wrong - embedded in the data, algorithms, models, guides, and tools we use in forest management.


#### Responsibilities {-#responsibilties-lq}

As a forest manager/planner, Lauren will support the project by providing valuable input on the relevance and application of project outcomes, specifically for future management applications, including determining vegetation density metrics.As a forest manager/planner, Lauren will support the project by providing valuable input on the relevance and application of project outcomes, specifically for future management applications, including determining vegetation density metrics.
