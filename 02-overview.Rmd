...
Develop an automated methodology to extract SPL point cloud information on, and surrounding each road segment, to build models of road condition including  attributes such as width, roughness, biomass on, and adjacent to, the road, and canopy cover above the road.
