...
**DEM:** Derived from LAS data. 

**DSM:** Derived from LAS data.

**CHM:** Derived from LAS data. 

**Other:** Fire extent 2021, Lakes and rivers, Land ownership, Plot inventory data, and Polygon inventory
...
**DEM:** Will be derived from LAS data. 

**DSM:** Will be derived from LAS data.

**CHM:** Will be derived from LAS data.

**Other:** Lakes and rivers, Land ownership, Plot inventory data, and Polygon inventory
